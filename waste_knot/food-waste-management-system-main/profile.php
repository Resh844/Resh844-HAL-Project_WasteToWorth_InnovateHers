...
<body>
<header>
        <div class="logo">Waste <b style="color: #06C167;">Knot</b></div>
        <div class="hamburger">
            <div class="line"></div>
            <div class="line"></div>
            <div class="line"></div>
    ...
    <!-- <section class="cover" >
     ...
     -->
        <div class="profilebox" style="">
            ...
            <p class="headingline" style="text-align: left;font-size:30px;"> <img src="" alt="" style="width:40px; height:max-content; padding-right: 10px; position: relative;" >Profile</p>
<!--             
