...
<head>
    ...
    <title>Provider Dashboard Panel</title> 
...
<body>
    <nav>
        <div class="logo-name">
            ...
            <span class="logo_name">PROVIDER</span>
        </div>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" >Waste <b style="color: #06C167; ">Knot</b></p>
             <p class="user"></p>
        ...
        <br>
          ...
          <form method="post">
            ...
            <select id="district" name="district" style="padding:10px; padding-left: 20px;">
                          ...
                          <option value="Nayandalli">Nayandalli</option>
                          <option value="Kengeri">Kengeri</option>
                          <option value="Whitefield">Whitefield</option>
                          <option value="Chikapete">Chikapete</option>
            </select>
